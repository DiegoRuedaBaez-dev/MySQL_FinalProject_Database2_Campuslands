...
-- Insercion Direcciones --

INSERT INTO vaddress (address_line, neighborhood, zip_code, id_city) VALUES
...
-- Insercion de Direcciones Proveedores --

INSERT INTO vprovider (id_vprovider, phone, vname) VALUES
...
-- Insercion de Direcciones de Proveedores -- 

INSERT INTO provider_address (id_vprovider, id_vaddress) VALUES
...
-- Insercion de Direcciones de Oficinas--
...
-- Insercion de Gamas de Productos --

INSERT INTO product_brand (brand, text_details, html_context, img) VALUES
...
-- Insercion de Medidas --

INSERT INTO measurements (height, width, deep, diameter, measure_type) VALUES
...
INSERT INTO producto (vname, details, provider_price, sell_price, id_measurements, id_vprovider, id_brand) VALUES
...
INSERT INTO inventory (id_products, on_stock, place) VALUES
(1, 50, 'Almacén 1'),
(2, 100, 'Almacén 2'),
(3, 80, 'Almacén 3'),
(4, 150, 'Almacén 4'),
...
INSERT INTO employees (id_employees, vname, sn1, sn2, extension, email, id_office, id_boss, position) VALUES
...
INSERT INTO client (id_client, vname_client, sn1_client, sn2_client, phone, id_employees_sellrep, credit_limit, id_contact_info) VALUES
...
-- Insercion Direcciones de Clientes --

INSERT INTO client_vaddress (id_client, id_vaddress) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
...
-- Insercion Estados de Pedidos --

INSERT INTO order_status (id_status, vstatus) VALUES
(1, 'En proceso'),
(2, 'En espera'),
(3, 'Completado'),
(4, 'Cancelado'),
...
-- Insercion Pagos Realizados --

INSERT INTO payment (id_client, payment_type, date_payment, total) VALUES
